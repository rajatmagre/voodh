        ...
        @include('Admin.session_message.error')
         <form id="staff-form" action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="col-md-8">            
                 <input type="text" class="form-control" id="staff_name" placeholder="Enter staff name." name="staff_name" data-rule-required="true" data-msg-required="Enter staff name." value="{{ old('staff_name') }}">
            ...
            <div class="row">
              ...
              <div class="col-md-8">            
                <input type="text" class="form-control" id="staff_employee_id" placeholder="Enter staff employee code." name="staff_employee_id" data-rule-required="true" data-msg-required="Enter staff employee code." value="{{ old('staff_employee_id') }}">
            ...
            <div class="row">
               ...
               <div class="col-md-8">            
                  <input type="text" class="form-control"  id="email" placeholder="Enter staff email." name="email" data-rule-required="true" data-msg-required="Enter staff email." data-rule-email="true" value="{{ old('staff_email') }}">
                   @if ($errors->has('email'))
            ...
            <div class="row">
                ...
                <div class="col-md-8">            
                  <input type="text" class="form-control" id="staff_contact_no" placeholder="Enter staff contact no." name="staff_contact_no" data-rule-required="true" data-msg-required="Enter staff contact no." onkeypress="return isNumberKey(event);" data-rule-number="true" data-rule-minlength="10"  data-msg-minlength="Please Enter Minimum 10 Digits" data-rule-maxlength="10"  data-msg-maxlength="You Can't Enter More Than 10 Digits" value="{{ old('staff_contact_no') }}">
            ...
            <div class="row">
               ...
               <div class="col-md-8">
                  <div class="select-box">
                      <select class="select2" name="staff_type_id" id="staff_type_id" data-rule-required="true" data-msg-required="Please Select staff type.">
                        <option value="">Select Type</option>
                        @if(!empty($all_staff_type) && count($all_staff_type) > 0)
                          @foreach($all_staff_type as $each_val)
                            <option value="{{ $each_val->staff_type_id }}" <?php if(old('staff_type_id')==$each_val->staff_type_id){ echo "Seleted";}?>>{{ $each_val->staff_type_name }}</option>
                          @endforeach
                        @endif
                      </select>
            ...
            <div class="row">
               <div class="col-md-4">
                ...
                <div class="col-md-8 browse-file-section">
                  ...
                  <span for="staff_image" class="error_validate"></span>
                  @if ($errors->has('staff_image'))
                    <span for="staff_image" class="error_validate">{{ $errors->first('staff_image') }}</span>
                  @endif
                </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-8">
                <div class="select-box">
                  <select class="select2" name="staff_status" id="staff_status" data-rule-required="true" data-msg-required="Please Select staff status.">
            ...
            <div class="row">
              <div class="col-md-9 offset-md-3">
                <div class="text-center form-btn">
                  <button type="submit" id="add_staff_btn" class="common-btn active">Add</button>
  ...
  $(document).ready(function (){
    $('#staff-form').validate({
         ...
         submitHandler: function (form) { 
            $('#add_staff_btn').attr('disabled','disabled');
           form.submit();
        }
    });
  });  
