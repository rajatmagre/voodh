    ...
    @include('Admin.session_message.error')
      <form id="staff-type-form" action="" method="POST">
        ...
        <div class="row">
           ...
           <div class="col-md-8">           
              <input type="text" class="form-control" id="staff_type_name" placeholder="Enter staff type." name="staff_type_name" data-rule-required="true" data-msg-required="Enter staff type." onkeypress="return lettersOnly(event);" >
        ...
        <div class="row">
           <div class="col-md-9 offset-md-3">
              <div class="text-center form-btn">
                 <button type="submit" class="common-btn active">Add</button>
